...
public class facecolor
{
    ...
    public void dialogShown_cb()
    {
        try
        {
            toggle0.GetProperties().SetLogical("Show",true);
    ...
    public int apply_cb()
    {
        ...
        try
        {
            ...
            else if (toggle0.GetProperties().GetLogical("Value"))
            {
                ...
                {
                    //mf.SetAttribute("加工面");
                    mf.DeleteAttributeByTypeAndTitle(NXObject.AttributeType.Any, "加工面）");
                }
            }
            //---- Enter your callback code here -----
        }
    ...
    public int update_cb( NXOpen.BlockStyler.UIBlock block)
    {
        try
        {
            if(block == toggle0)
            {
                if (toggle0.GetProperties().GetLogical("Value"))
                {
                    colorPicker0.GetProperties().SetLogical("Enable",false);
                }
                else if (!toggle0.GetProperties().GetLogical("Value"))
                {
                    colorPicker0.GetProperties().SetLogical("Enable",true);
                }
            //---------Enter your code here-----------
            }
