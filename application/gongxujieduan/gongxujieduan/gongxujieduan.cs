...
//
//       Filename:  C:\Users\Jerry\Desktop\gongxujieduan.cs
//
//        This file was generated by the NX Block UI Styler
//        Created by: Jerry
//              Version: NX 7.5
//              Date: 06-25-2012  (Format: mm-dd-yyyy)
//              Time: 11:07 (Format: hh-mm)
//
//==============================================================================
...
//------------------------------------------------------------------------------
public class gongxujieduan
{
    //class members
    private static Session theSession = null;
    private static UI theUI = null;
    public static gongxujieduan thegongxujieduan;
    ...
    public static NXOpen.TaggedObject[] theoriPart;// 不用从外部选择，直接用选择器进行选择即可。
    //------------------------------------------------------------------------------
    ...
    //------------------------------------------------------------------------------
    public gongxujieduan()
    {
        try
        {
            theSession = Session.GetSession();
            theUI = UI.GetUI();
            theDialogName = "gongxujieduan.dlx";
    ...
    public static void Main()
    {
        try
        {
            thegongxujieduan = new gongxujieduan();
            // The following method shows the dialog immediately
            thegongxujieduan.Show();
        }
        catch (Exception ex)
        {
            //---- Enter your exception handling code here -----
